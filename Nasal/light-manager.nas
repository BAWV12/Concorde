...
var light_manager = {
    ...
    update: func {
        ...
        setprop("/sim/rendering/als-secondary-lights/lightspot/eyerel-z-m[2]", -0.4);
        ...
        setprop("/sim/rendering/als-secondary-lights/lightspot/eyerel-z-m[3]", -0.4);
	...
	# light 5 position
        ...
        setprop("/sim/rendering/als-secondary-lights/lightspot/eyerel-z-m[4]", 0.27);
